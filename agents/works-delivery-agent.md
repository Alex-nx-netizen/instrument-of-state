---
name: works-delivery-agent
description: Implement approved code, scripts, docs, and automation after Menxia approval. Use proactively for actual delivery once the memorial is approved, the execution order is clear, and the docket has already done planning and review, including governed frontend work.
